            ...
            <div className='relative mt-[6rem] about-conatiner'>
                ...
                <div className='relative w-full grid gap-2 place-content-center sm:gap-4 about-grid z-20'>
                    ...
                    <motion.div
                        ...
                        <p className='md:text-lg'>Full stack web development</p>
                        <p className='md:text-lg'>React-Native app development</p>
                    </motion.div>
                    <motion.div
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                    ...
                    <motion.div
                        ...
                        <a href='https://drive.google.com/file/d/1Fak-I1l5CynzSGxvF0UxL11ccOBh4S3C/view?usp=sharing' target='_blank' className='text-[2rem] md:text-[3rem] font-bold'>CV</a>
                    </motion.div>
                    <motion.div
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
